...
def test_relationExprs():
  assert expected(eqExpr <= ' eq 5', EqExpr, {'common_expr': PrimitiveLiteral,
                                              'common_expr.value': 5})


def test_comparisonExpr():
  assert expected(boolPredicateExpr <= 'Foo eq 5', ComparisonExpr, {'common_expr': Identifier,
                                                                    'common_expr.name': 'Foo',
                                                                    'relation_expr': EqExpr,
                                                                    'relation_expr.common_expr': PrimitiveLiteral,
                                                                    'relation_expr.common_expr.value': 5})

  assert expected(boolPredicateExpr <= "'Thomas' eq FirstName", ComparisonExpr, {'common_expr': PrimitiveLiteral,
                                                                                 'common_expr.value': 'Thomas',
                                                                                 'relation_expr': EqExpr,
                                                                                 'relation_expr.common_expr': Identifier,
                                                                                 'relation_expr.common_expr.name': "FirstName"})
